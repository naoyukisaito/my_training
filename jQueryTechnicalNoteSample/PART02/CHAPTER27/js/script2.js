...
$(function(){
	...
	setElm.each(function(){
		...
		if(selfWidth < slideWidth){
			self.append('<a href="javascript:void(0);" class="btnPrev"></a><a href="javascript:void(0);" class="btnNext"></a><div class="pagiNation"></div>').find('ul').wrapAll('<div class="slideWrap" />');
